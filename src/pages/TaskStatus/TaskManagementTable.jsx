...
//   // Function to fetch a pre-signed URL from backend
//   const getPresignedUrl = async () => {
//     try {
//       const response = await fetch(`${import.meta.env.VITE_APP_BASE_URL}/service/uploadFile`);
//       const data = await response.json();
...
//   const submitData = async() => {
//     // Filter out tasks that don't have essential data
...
//     // Prepare data for backend including S3 URLs
//     const formattedData = validTasks.map(task => ({
//       task_name: task.task_name,
//       task_file: task.file_url ? task.file_url : "",
//       notes: task.notes,
//       assigned_to: task.assigned_to,
...
//             <AlertDialogDescription>
//               Your tasks have been successfully submitted to the backend.
//               {tasks.filter(t => t.task_name && t.task_name.trim() !== "").length} task(s) processed and data sent for database insertion.
//             </AlertDialogDescription>
//           </AlertDialogHeader>
//           <AlertDialogFooter>
//             <AlertDialogAction onClick={() => setShowSuccessDialog(false)}>
